...
function App() {
  ...
  return (
    <div className="w-full min-h-screen bg-slate-100 flex flex-col font-sans text-slate-900">
      ...
      <main className="w-full max-w-6xl mx-auto p-4 md:p-8 flex-grow flex flex-col items-center justify-center">
        <div className="w-full bg-white rounded-2xl shadow-sm border border-gray-200 p-8 md:p-12 text-center">
          
          {activeTab === 'home' && (
            <div className="animate-in fade-in flex flex-col items-center justify-center space-y-8">
